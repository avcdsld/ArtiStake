    ...
    HasSecondarySaleFees
{
    ...
    string public constant defaultBaseURI =
        "https://raw.githubusercontent.com/avcdsld/MetaverStake/master/packages/contracts-nft/metadata/";
    ...
    function mint(address[] memory _toList) public onlyOwner {
        for (uint256 i = 0; i < _toList.length; i++) {
            tokenIdCounter += 1;
            _mint(_toList[i], tokenIdCounter);
        }
    }
